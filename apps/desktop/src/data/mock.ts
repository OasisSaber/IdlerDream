...
export const mockProjects: ProjectEnvelope[] = [
  {
    ...
    runtime: {
      ...
      tests: { status: "passed", passed: 21, failed: 0, skipped: 0, summary: "21 passed" }, changed_paths: ["apps/desktop/src/App.tsx", "apps/sidecar/idlerdream/api.py"], file_count_considered: 118,
  ...
  },
  {
    ...
    runtime: { project_id: "3e903e08-4480-43d8-a51e-5aab96d11103", workspace_path: "D:/Projects/media-harbor-skill", workspace_fingerprint: "demo-3b", observed_at: iso(0), vcs: { kind: "git", head: "77bcaf2", branch: "main", changed_files: 1, untracked_files: 0, status_summary: "1 modified" }, tests: { status: "failed", passed: 8, failed: 1, skipped: 0, summary: "8 passed, 1 failed" }, changed_paths: ["tests/test_environment.py"], file_count_considered: 52, agents: [], warnings: [] },
  },
  {
