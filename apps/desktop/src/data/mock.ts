...
export const mockProjects: ProjectEnvelope[] = [
  {
    ...
    state: {
      ...
      risks: [], progress: { mode: "acceptance_count", completed: 2, total: 4 }, workspace_fingerprint: "demo-1", verified_at: iso(3), updated_at: iso(1), needs_user_attention: false, inspection_quality: "partial", inspection_warnings: ["Normalizer: defaulted inferences[0].kind to model."], inspection_error: null,
    },
    runtime: {
  ...
  },
  {
    ...
    state: { project_id: "4e903e08-4480-43d8-a51e-5aab96d11104", core_status: "in_progress", phase: "UI 重构", summary: "最近一次验证停留在首页卡片组件重构。", next_action: { actor: "agent", action: "继续完成商品详情页组件迁移" }, confidence: .61, freshness: "expired", activity_state: "inactive", facts: [], inferences: [], risks: [], progress: { mode: "none", completed: null, total: null }, workspace_fingerprint: "demo-4", verified_at: iso(5600), updated_at: iso(5400), needs_user_attention: false, inspection_quality: "failed", inspection_warnings: [], inspection_error: null },
